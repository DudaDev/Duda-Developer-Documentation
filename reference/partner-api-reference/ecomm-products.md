...
{% swagger method="get" baseUrl="https://api.duda.co/api" expanded="false" fullWidth="false" summary="List Products" path="/sites/multiscreen/{site_name}/ecommerce/products" %}
{% swagger-description %}
Get products page. Default page response size is 50, max requested page size is 100.
...
{% swagger baseUrl="https://api.duda.co/api" expanded="false" method="get" summary="Get Product" path="/sites/multiscreen/{site_name}/ecommerce/products/{product_id}" %}
{% swagger-description %}
...
{% swagger method="post" path="/sites/multiscreen/{site_name}/ecommerce/products" baseUrl="https://api.duda.co/api" summary="Create Product" expanded="false" %}
{% swagger-description %}
...
{% swagger method="patch" path="/sites/multiscreen/{site_name}/ecommerce/products/{product_id}" baseUrl="https://api.duda.co/api" summary="Update Product" expanded="false" %}
{% swagger-description %}
...
{% swagger method="delete" path="/sites/multiscreen/{site_name}/ecommerce/products/{product_id}" baseUrl="https://api.duda.co/api" summary="Delete Product" expanded="false" %}
{% swagger-description %}
