...
{% swagger method="get" baseUrl="https://api.duda.co/api" expanded="false" fullWidth="false" summary="List Carts" path="/sites/multiscreen/{site_name}/ecommerce/carts" %}
{% swagger-description %}
...
{% swagger baseUrl="https://api.duda.co/api" expanded="false" method="get" summary="Get Cart" path="/sites/multiscreen/{site_name}/ecommerce/carts/{cart_id}" %}
{% swagger-description %}
