...
{% swagger method="get" baseUrl="https://api.duda.co/api" expanded="false" fullWidth="false" summary="Get Payment Session" path="/sites/multiscreen/{site_name}/ecommerce/payment-sessions/{session_id}" %}
{% swagger-description %}
...
{% swagger baseUrl="https://api.duda.co/api" expanded="false" method="post" summary="Confirm Payment" path="/sites/multiscreen/{site_name}/ecommerce/payment-sessions/{session_id}/confirm" %}
{% swagger-description %}
