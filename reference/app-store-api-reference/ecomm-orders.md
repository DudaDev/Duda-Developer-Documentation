...
{% swagger method="get" baseUrl="https://api-sandbox.duda.co/api" expanded="false" fullWidth="false" summary="List Orders" path="/integrationhub/application/site/{site_name}/ecommerce/orders" %}
{% swagger-description %}
...
```sh
curl --request GET \
     --url 'https://api-sandbox.duda.co/api/integrationhub/application/site/site_name/ecommerce/orders?offset=0' \
...
{% swagger baseUrl="https://api-sandbox.duda.co/api" expanded="false" method="get" summary="Get Order" path="/integrationhub/application/site/{site_name}/ecommerce/orders/{order_id}" %}
{% swagger-description %}
...
```sh
curl --request GET \
     --url https://api-sandbox.duda.co/api/integrationhub/application/site/site_name/ecommerce/orders/order_id \
     --header 'accept: application/json' \
     --header 'x-access-token: {access_token}'
```
{% endtab %}
...
{% swagger baseUrl="https://api-sandbox.duda.co/api" expanded="false" method="patch" summary="Get Order" path="/sites/multiscreen/{site_name}/ecommerce/orders/{order_id}" %}
{% swagger-description %}
...
{% swagger-parameter in="body" name="items" type="array of objects" %}
...
{% swagger-parameter in="body" name="shipping_address" type="object" %}

{% endswagger-parameter %}

{% swagger-parameter in="body" name="shipping_instructions" type="string" %}
A detailed description of shipping instructions for the merchant.
{% endswagger-parameter %}
...
```sh
curl --request PATCH \
     --url 'https://api-sandbox.duda.co/api/integrationhub/application/site/site_name/ecommerce/orders/order_id%20(COPY)' \
     --header 'accept: application/json' \
